...
const title = ['Image', 'Name', 'Price', 'Description', 'Status'];
export default function Product() {
  ...
  const changeStatus = (e: React.ChangeEvent<HTMLInputElement>, id: string): void => {
    const status = e.target.checked;
    const updates = { status: status };
    servicesProduct.update(updates, id);
  };
  ...
  return (
    <>
      <EditForm open={showEdit} setOpen={setShowEdit} id_product={id_product.current} />
